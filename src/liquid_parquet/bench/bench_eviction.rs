...
fn access_patterns_hits_only() {
    // Read all trace data into memory first
    let mut trace_data = Vec::new();
    /*let access_counts: std::collections::HashMap<u64, u32> = std::collections::HashMap::new();
    let previous_access_counts: std::collections::HashMap<u64, u32> =
        std::collections::HashMap::new();
    let previous_access_distribution: std::collections::HashMap<u32, u32> =
        std::collections::HashMap::new();*/
    let paths = fs::read_dir("./trace").expect("Failed to read directory");
    ...
    let mut hit_access_counts: std::collections::HashMap<u64, u32> =
        std::collections::HashMap::new();
    let mut hit_previous_access_counts: std::collections::HashMap<u64, u32> =
        std::collections::HashMap::new();
    let mut hit_previous_access_distribution: std::collections::HashMap<u32, u32> =
        std::collections::HashMap::new();
    ...
    for key in &trace_data {
        if cache.contains_key(key) {
            ...
            *hit_previous_access_distribution
                .entry(*previous_hit_count)
                .or_insert(0) += 1;
    ...
    let mut hit_frequency_distribution: std::collections::HashMap<u32, u32> =
        std::collections::HashMap::new();
    for count in hit_access_counts.values() {
